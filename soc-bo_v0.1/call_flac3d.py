...
while True:
    ...
    it.command(f"""
        ...
        ; Stress boundary
        zone face apply stress-xx {} gradient (0,0,{}) range position-x -0.1 0.1 position-z 2500 4660
        zone face apply stress-yy {} gradient (0,0,{}) range position-y -0.1 0.1 position-z 2500 4660
        zone face apply stress-xy {} range position-x -0.1 0.1
        zone face apply stress-xy {} range position-x 2999 3001
        zone face apply stress-xy {} range position-y -0.1 0.1
        zone face apply stress-xy {} range position-y 4999.5 5000.5
               
        model gravity 0 0 {}    
    """).format(sx0, tidu1, sy0, tidu2,sxy1, gravity_value)
